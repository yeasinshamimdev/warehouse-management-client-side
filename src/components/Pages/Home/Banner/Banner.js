                ...
                <div className="carousel-inner relative w-full overflow-hidden">
                    ...
                    <div className="carousel-item active relative float-left w-full">
                        ...
                        <div className="carousel-caption md:block absolute text-center">
                            ...
                            <button className='bg-green-500 md:block px-6 py-1 md:px-10 md:py-2 md:mt-4 rounded text-white text-xs mt-4 md:text-xl cursor-pointer mx-auto hover:bg-green-400 md:mb-2'>Explore</button>
                        </div>
                    </div>
