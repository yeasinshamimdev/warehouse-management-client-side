            ...
            <div className='border-2 mt-6 px-5 py-4 rounded-lg bg-slate-200'>
                <div className='mb-8'>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <input type='text' className='w-full border mb-4 mt-1 h-10 px-2 rounded focus:outline-none' {...register("name", { required: true, maxLength: 20 })} name="name" placeholder='Your name' />
